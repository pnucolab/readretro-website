        ...
        <div class="mx-auto flex flex-col container">
            <div class="flex flex-row gap-14 mb-10 justify-center">
                <div class="flex flex-col">
                    ...
                    <A href="https://sites.google.com/view/kimlab" target="_blank"><img class="w-52" src="/ecolab.png" alt="Laboratory for Ecology at Korea Advanced Institute for Science & Technology" /></A>
                </div>
                <div class="flex flex-col">
